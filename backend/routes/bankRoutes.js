...
router.get('/admin/accounts', adminAuth, getAllBankAccounts);
...
// @access  Private (Admin)
router.post('/admin/accounts/:id/verify', adminAuth, verifyBankAccount);

// @route   POST /api/bank/admin/accounts/:id/reject
// @desc    Reject bank account
// @access  Private (Admin)
router.post('/admin/accounts/:id/reject', adminAuth, rejectBankAccount);

// @route   PUT /api/bank/admin/accounts/:id/status
// @desc    Update bank account status
// @access  Private (Admin)
router.put('/admin/accounts/:id/status', adminAuth, updateBankAccountStatus);

// @route   DELETE /api/bank/admin/accounts/:id
// @desc    Delete bank account (Admin)
// @access  Private (Admin)
router.delete('/admin/accounts/:id', adminAuth, adminDeleteBankAccount);

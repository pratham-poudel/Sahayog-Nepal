...
router.get('/campaign/:campaignId/recent', protect, checkBanStatus, donationController.getRecentDonations);

// GET /api/donations/campaign/:campaignId/top-donor - Get top donor for a campaign
router.get('/campaign/:campaignId/top', protect, checkBanStatus, donationController.getTopDonor);

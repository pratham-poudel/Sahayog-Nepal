...
const RegisterModal = ({ isOpen, onClose }) => {
  ...
  const { registerAndRedirect } = useAuthContext();
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const success = await registerAndRedirect(data.name, data.email, data.password);
      if (success) {
        toast({
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-4">
                ...
                <input 
                  type="text" 
                  id="name" 
                  className={`w-full py-2 px-3 border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-transparent`}
              ...
              <div className="mb-6">
                ...
                <input 
                  type="password" 
                  id="confirmPassword" 
                  className={`w-full py-2 px-3 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-600 focus:border-transparent`}
                  placeholder="••••••••"
            ...
            <div className="relative flex items-center justify-center mt-6 mb-6">
              ...
              <div className="bg-white px-4 relative z-10 text-sm text-gray-500">or register with</div>
            </div>

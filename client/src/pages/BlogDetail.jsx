...
const BlogDetail = () => {
  ...
  const [relatedBlogs, setRelatedBlogs] = useState([]);  const [isLoading, setIsLoading] = useState(true);
  ...
  const articleRef = useRef(null);  // Handle scroll for reading progress and scroll-to-top button
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
          ...
          <div className="container mx-auto px-4 pb-12">
            <div className="max-w-4xl mx-auto">
              ...
              >                <div className="flex items-center gap-3">
                  <img 
                    src={getImageUrl(blog.author?.profilePicture, 'profile', 'https://ui-avatars.com/api/?name=' + encodeURIComponent(blog.author?.name || 'Anonymous'))}
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <motion.button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-gray-700 dark:bg-gray-600 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-gray-700 transition-colors"
                >
      ...
      <section className="py-8 lg:py-12">
        ...
        <main className="w-full" ref={articleRef}>
          <motion.article
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.3 }}
            className="bg-white dark:bg-gray-800 shadow-lg border-t border-b border-gray-200 dark:border-gray-700 w-full"
          >
              {/* Article Excerpt */}
            {blog.excerpt && (
              <div className="w-full border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-800">
                ...
                <div className="w-full flex justify-center">
                  <div className="w-full max-w-[80%] prose prose-lg dark:prose-invert prose-headings:font-bold prose-headings:text-gray-900 dark:prose-headings:text-white prose-p:text-gray-700 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-a:text-[#8B2325] dark:prose-a:text-[#a32729] prose-strong:text-gray-900 dark:prose-strong:text-white px-6 py-8 lg:px-12 lg:py-10"
                        ...
                        case 'image':
                          return (
                            <motion.figure 
                              ...
                              className="my-8"
                            >
                              <div className="overflow-hidden rounded-xl shadow-lg">                                <img 
                                  src={getImageUrl(block.url, 'blog')} 
                ...
                {/* Article Footer */}
                <footer className="border-t border-gray-200 dark:border-gray-700 px-6 py-8 lg:px-8 lg:py-10 bg-gray-50 dark:bg-gray-800/50">                  <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                    {/* Author Info */}                    <div className="flex items-center gap-4 flex-1">
                      <img 
                        src={getImageUrl(blog.author?.profilePicture, 'profile', 'https://ui-avatars.com/api/?name=' + encodeURIComponent(blog.author?.name || 'Anonymous'))}
                        alt={blog.author?.name || 'Anonymous'}
